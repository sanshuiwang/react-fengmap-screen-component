...
function (_Component) {
  ...
  function FengmapBase(props) {
    ...
    _this.mapContainer = React__default.createRef();
    _this.loadingTxt = React__default.createRef();
...
function (_Component) {
  ...
  _createClass(FengmapFloors, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(FengmapBase, _extends({}, props, {
        isFengmapBase: false,
        ref: props.reference,
...
var FengmapFloors$1 = React__default.forwardRef(function (props, ref) {
  return React__default.createElement(FengmapFloors, _extends({
    reference: ref
  }, props));
});
...
function (_FengmapBaseControl) {
  ...
  function FengmapRotateControl(_props) {
    ...
    _this.rotateControl = React__default.createRef();
    return _this;
  }
...
function (_React$Component) {
  ...
  _createClass(HorizontalButtonGroupsControl, [{
    ...
    value: function render() {
      ...
      }, this._getDisplayGroups(containerPosition), React__default.createElement("div", {
...
function (_FengmapBaseControl) {
  ...
  _createClass(FengmapFloorControl, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(ButtonGroupsControl, {
        ctrlOptions: ctrlOptions || {},
        height: map.height,
        sdk: fengmapSDK,
        map: map,
...
exports.Fengmap3DControl = Fengmap3DControl;
exports.FengmapBase = FengmapBase;
exports.FengmapCompassControl = FengmapCompassControl;
exports.FengmapFloorControl = FengmapFloorControl;
exports.FengmapFloors = FengmapFloors$1;
exports.FengmapImageMarker = FengmapImageMarker;
exports.FengmapNavigation = FengmapNavigation;
exports.FengmapResetControl = FengmapResetControl;
exports.FengmapRotateControl = FengmapRotateControl;
exports.FengmapZoomControl = FengmapZoomControl;
